...
from phish_email_detection_agent.tools.url_analysis import SafeFetchPolicy, _safe_fetch_url_internal
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--user-agent", type=str, default="ArgisSafeFetcher/2.0")
